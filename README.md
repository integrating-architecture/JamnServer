...
Since the server only supports HTTP in a rudimentary way, it is **NOT SUITABLE FOR PRODUCTION PURPOSES** – but it is quick and easy to use for tooling, testing and concept experiments.
